...
```bash
bash <(curl -s https://raw.githubusercontent.com/luxzdev02/themeinstaller/refs/heads/main/install.sh)
```
## ✨ Fitur Utama
...
- Github Profile: [LUXZ OFFICIAL](https://github.com/luxzdev02)
- Telegram Channel: [KLIK DI SINI](https://t.me/luxzchh)
- Telegram Chat: [HUBUNGI ATMIN](https://t.me/luxzoffc02)
